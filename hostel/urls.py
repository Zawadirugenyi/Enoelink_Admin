...
from .views import (
    MpesaPaymentView, MpesaCallbackView, RoomListCreateView, RoomDescriptionListCreateView,
    RoomDetailView, RoomDescriptionDetailView, HostelListCreateView, HostelDetailView,
    TenantListCreateView, TenantDetailView, StaffListCreateView, StaffDetailView,
    BookingListCreateView, BookingDetailView, BookingByRoomAndTenantView,
    MaintenanceListCreateView, MaintenanceDetailView, FacilityListCreateView,
    FacilityDetailView, PaymentListCreateView, PaymentDetailView, NotificationListCreateView,
    NotificationDetailView, admin_send_notification, user_request_requisition
)
...
urlpatterns = [
    ...
    path('bookings/room/<int:room_id>/tenant/<int:tenant_id>/', BookingByRoomAndTenantView.as_view(), name='booking-by-room-tenant'),  # New endpoint
